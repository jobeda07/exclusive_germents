...
class CreateCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('trending')->default(0)->comment('1=>Trending, 0=>Not Trending');
            $table->unsignedTinyInteger('special')->default(0)->comment('1=>Special, 0=>Not Special');
