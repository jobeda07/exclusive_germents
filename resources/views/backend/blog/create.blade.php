                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <label for="description" class="col-form-label col-md-2" style="font-weight: bold;"> Description </label>
                                    <textarea name="description" id="description" cols="5" placeholder="Write page description english" class="form-control summernote">{{old('description')}}</textarea>
                                    @error('description')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
