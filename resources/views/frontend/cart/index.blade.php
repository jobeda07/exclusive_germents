        ...
        <div class="row">
                    ...
                    <table class="table table-wishlist">
                        <thead>
                            <tr class="main-heading">
                                <th scope="col" width="10px" class="text-center">Image</th>
                                <th scope="col" width="300px" class="text-center">Product</th>
                                <th scope="col" width="50px" class="text-center">Price</th>
                                <th scope="col" width="10px" class="text-center">Quantity</th>
                                <th scope="col" width="10px" class="text-center">Subtotal</th>
                                <th scope="col" width="10px" class="end">Remove</th>
                            </tr>
                        </thead>
            ...
            <div class="col-lg-4">
                <div class="border p-md-4 cart-totals">
                    ...
                    <a href="{{ route('checkout')}}" class="btn w-100 proceedCheckout">Proceed To CheckOut<i class="fi-rs-sign-out ml-15"></i></a>
                </div>
            </div>
        </div>
    </div>
