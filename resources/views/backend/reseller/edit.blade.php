		            ...
		            <div class="row">
		                <div class="col-md-12">
		                    ...
		                    <form method="POST" action="{{ route('reseller.update',['id'=>$reseller->id]) }}" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="fb_web_url" class="col-form-label col-md-4 fw-bold">Facebook page link/ Website link : <span class="text-danger"> *</span></label>
									<input type="text" class="form-control" name="fb_web_url" id="fb_web_url" placeholder="Facebook page link/ Website link" value="{{ $reseller->fb_web_url }}" required/>
									@error('fb_web_url')
										<div class="text-danger" style="font-weight: bold;">{{ $message }}</div>
									@enderror
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="form-group">
									<label for="wallet_default_amount" class="col-form-label col-md-4 fw-bold">Wallet Default Amount : <span class="text-danger"> *</span></label>
								...
								@if($reseller->is_approved==0)
                                    <div class="form-group">
                                        <label for="wallet_balance" class="col-form-label col-md-4 fw-bold">Wallet Amount Advance ADD : <span class="text-danger"> *</span></label>
