                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                @if (!(Auth::guard('admin')->user()->role == '2'))
                                    ...
                                    <tr>
                                        <th>Sub Total</th>
                                        <td>{{ ($order->sub_total+$extraPay) ?? '0.00' }} <strong>Tk</strong></td>

                                        <th>Total</th>
                                        <td>{{ $order->collectable_amount }} <strong>Tk</strong>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                   ...
                                   @endif
                                    ...
                                    @endif
                                    <th width="20%" class="text-center">Extra</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-center">{{ $extra }} TK</td>
                                    <td class="text-end" id="item_totalPrice_{{ $key }}">{{ ($orderDetail->price * $orderDetail->qty) + $extra ?? '0.00' }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
