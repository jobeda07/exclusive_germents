                                            ...
                                            <div class="invoice-name">
                                                <div class="logo w-50">
                                                    ...
                                                    <div>
                                                        ...
                                                        <abbr title="Address">Address: </abbr>Noyagaw Suchayan Academy
                                            ...
                                            <tbody>
                                                        ...
                                                        <td>
                                                            <div class="item-desc-1">
                                                                <span>
                                                                    ...
                                                                    @if ($order_detail->is_varient)
                                                                        @php
                                                                            $jsonString = $order_detail->variation;
                                                                            $combinedString = '';
                                                                            $jsonArray = json_decode($jsonString, true);
                                                                            foreach ($jsonArray as $attribute) {
                                                                                if (
                                                                                    isset($attribute['attribute_value'])
                                                                                ) {
                                                                                    $combinedString .=
                                                                            ...
                                                                            $stockId = App\Models\ProductStock::where(
                                                                                ...
                                                                                ->where('varient', $combinedString)
                                                                                ->first();
                                                                        @endphp
                                                                        (code: {{ $stockId->stock_code ?? ' ' }})
                                                                    @else
                                                                        (code :
                                                                        {{ $order_detail->product->product_code ?? ' ' }} )
                                                                    @endif
                                                                </span>
                                                                <span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right f-w-600">
                                                        {{ ($order->grand_total - $order->discount ?? ' ') + $extraPay }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
