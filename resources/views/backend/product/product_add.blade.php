		        	...
		        	<div class="card-body">
		        		...
		        		<div class="row">
		                    ...
		                    <div class="col-md-6 mb-4">
                                ...
                                <input class="form-control" id="product_sku" type="text" name="product_sku" placeholder="Write Product SKU" value="{{old('product_sku')}}">
                                @error('product_sku')
		                            <p class="text-danger">{{$message}}</p>
		                        @enderror
                            </div>
		        ...
		        <div class="card">
		        	...
		        	<div class="card-body">
						...
						<div class="mb-4">
							...
							<input class="form-control" id="youtube_link" type="text" name="youtube_link" placeholder="Write Product YouTube Link" value="{{old('youtube_link')}}">
					   	</div>
						<!-- Porduct Image End -->
		        		<!-- Checkbox Start -->
                        <div class="mb-4">
