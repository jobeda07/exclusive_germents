				    ...
				    <div class="card">
				        ...
				        <div class="card-body">
				        	<div class="row">
		                        ...
		                        <div class="col-sm-6 mb-3">
		                           <label for="tiktok_url" class="col-form-label" style="font-weight: bold;">Tiktok Link :</label>
		                           <input type="hidden" name="types[]" value="linkedin_url">
		                            <input class="form-control" type="text" name="tiktok_url" id="tiktok_url" placeholder="Write Tiktok url" value="{{ get_setting('tiktok_url')->value ?? 'Null' }}">
		                            @error('tiktok_url')
		                                <p class="text-danger">{{$message}}</p>
		                            @enderror
		                        </div>
